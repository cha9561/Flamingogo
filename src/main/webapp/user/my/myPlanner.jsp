<%@ page language="java" contentType="text/html; charset=EUC-KR"
   ...
   .container
   {
   	width:100%; position:relative; margin:5%;
   }
   .row
   { float:left; height:260px;transition:all 0.5s; animation:scale 1s 1;}
   </style>
</head>
<body>
   <!-- Page Content -->
    ...
    <div class="col-md-3">
      <div class="panel space-4">
        <!-- <div class="media media-photo-block
            ">
          <a href="/users/show/21056203" title="프로필 보기"><img alt="Heera" class="img-responsive" height="190" src="https://a1.muscache.com/im/users/21056203/profile_pic/1410124458/original.jpg?aki_policy=profile_x_medium" title="Heera" width="190" /></a>
        </div> -->
        ...
        <div class="panel-body">
          ...
          <ul class="list-unstyled text-center">
            <li>
            <a href="/users/show/21056203">프로필 보기</a>
            </li>
            <li>
                <a href="/users/edit" id="edit-profile">프로필 수정</a>
            </li>
          </ul>
        </div>
      </div>
...
<!--  <div class="row">
 ...
 <div class="col-md-9">
        ...
        <div class="mdl-tabs__tab-bar">
          <a href="#about-panel" class="mdl-tabs__tab is-active">나의플래너관리</a>
          <a href="#members-panel" class="mdl-tabs__tab">구매관리</a>
          <a href="#albums-panel" class="mdl-tabs__tab">위시리스트관리</a>
          <a href="#board-panel" class="mdl-tabs__tab">나의글관리</a>
       </div>
